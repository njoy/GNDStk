...
#ifndef NJOY_GNDSTK_V2_0_FISSIONTRANSPORT_NEUTRINOENERGY
#define NJOY_GNDSTK_V2_0_FISSIONTRANSPORT_NEUTRINOENERGY
...
class NeutrinoEnergy : public Component<NeutrinoEnergy> {
   ...
   static auto className() { return "NeutrinoEnergy"; }
   static auto GNDSName() { return "neutrinoEnergy"; }
...
public:
   ...
   // polynomial1d(value)
   NeutrinoEnergy &polynomial1d(const std::optional<containers::Polynomial1d> &obj)
   ...
   // from node
   NeutrinoEnergy(const Node &node) :
      Component{
         BodyText{},
         content.polynomial1d
      }
   ...
   #include "GNDStk/v2.0/fissionTransport/NeutrinoEnergy/src/custom.hpp"
