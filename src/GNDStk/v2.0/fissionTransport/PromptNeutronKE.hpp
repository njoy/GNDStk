...
#ifndef NJOY_GNDSTK_V2_0_FISSIONTRANSPORT_PROMPTNEUTRONKE
#define NJOY_GNDSTK_V2_0_FISSIONTRANSPORT_PROMPTNEUTRONKE
...
class PromptNeutronKE : public Component<PromptNeutronKE> {
   ...
   static auto className() { return "PromptNeutronKE"; }
   static auto GNDSName() { return "promptNeutronKE"; }
...
public:
   ...
   // XYs1d(value)
   PromptNeutronKE &XYs1d(const std::optional<containers::XYs1d> &obj)
      { XYs1d() = obj; return *this; }

   // polynomial1d(value)
   PromptNeutronKE &polynomial1d(const std::optional<containers::Polynomial1d> &obj)
   ...
   // from node
   PromptNeutronKE(const Node &node) :
      Component{
         BodyText{},
         content.XYs1d,
         content.polynomial1d
   ...
   #include "GNDStk/v2.0/fissionTransport/PromptNeutronKE/src/custom.hpp"
