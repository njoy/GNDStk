...
#ifndef NJOY_GNDSTK_V2_0_CONTAINERS_LINK
#define NJOY_GNDSTK_V2_0_CONTAINERS_LINK
...
public:
   ...
   // href(value)
   Link &href(const std::optional<std::string> &obj)
   ...
   #include "GNDStk/v2.0/containers/Link/src/custom.hpp"
