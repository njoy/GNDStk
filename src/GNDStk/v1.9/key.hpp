...
// This file contains Meta and Child objects for the given GNDS version.
// If someone wishes to use the GNDS Core Interface in conjunction with
// the higher-level autogenerated classes, these will help.
...
using njoy::GNDStk::core::Meta;
using njoy::GNDStk::core::Child;
