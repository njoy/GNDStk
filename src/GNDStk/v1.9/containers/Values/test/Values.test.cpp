...
SCENARIO( "Values" ) {
  ...
  GIVEN( "valid data for the component - doubles" ) {
    ...
    WHEN( "autogenerated constructor: the data is given explicitly" ) {
      ...
      Values chunk( std::nullopt, std::nullopt, std::nullopt, values );
  ...
  GIVEN( "valid data for the component - ints" ) {
    ...
    WHEN( "autogenerated constructor: the data is given explicitly" ) {
      ...
      std::string valueType = "Integer32";
      std::vector< Integer32 > values = { 2500, 9, 2550, 9 };

      Values chunk( std::nullopt, std::nullopt, valueType, values );
...
std::string chunk() {
  ...
  return
R"***(<values>2500 8.9172 2550 8.9155</values>
)***";
}

void verifyChunk( const Values& component ) {

  CHECK( std::nullopt == component.length() );
...
std::string chunkInts() {
  ...
  return
R"***(<values valueType="Integer32">2500 9 2550 9</values>
)***";
}
...
std::string chunkStrings() {
  ...
  return
R"***(<values valueType="XMLName">2500 8.9172 2550 8.9155</values>
)***";
}
...
void verifyChunkStrings( const Values& component ) {
  ...
  CHECK( std::nullopt == component.length() );
  CHECK( 0 == component.start() );
  CHECK( "XMLName" == component.valueType().value() );
