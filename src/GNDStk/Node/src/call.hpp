...
// call meta<TYPE>() or child<TYPE> directly. Implementing the variant versions
// here would bulk up this file, and you'd need to write the operator call in
// functional form, e.g. mynode.operator()<TYPE>(...), to use it.
...
decltype(auto) operator()(
   ...
   try {
      if (kwd.name == "")
         detail::apply_keyword<TYPE>()(kwd,*this);
