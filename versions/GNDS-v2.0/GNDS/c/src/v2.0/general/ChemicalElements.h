...
#ifndef C_INTERFACE_GNDS_V2_0_GENERAL_CHEMICALELEMENTS
#define C_INTERFACE_GNDS_V2_0_GENERAL_CHEMICALELEMENTS
...
#include "v2.0/general/ChemicalElements/src/custom.h"
