...
!! Has
function Polynomial1dLabelHas(handle) &
      bind(C, name='Polynomial1dLabelHas')
   use iso_c_binding
   implicit none
   type(c_ptr), intent(in), value :: handle
   integer(c_int) :: Polynomial1dLabelHas
end function Polynomial1dLabelHas

!! Get
function Polynomial1dLabelGet(handle) &
      bind(C, name='Polynomial1dLabelGet')
   use iso_c_binding
   implicit none
   type(c_ptr), intent(in), value :: handle
   type(c_ptr) :: Polynomial1dLabelGet
end function Polynomial1dLabelGet

!! Set
subroutine Polynomial1dLabelSet(handle, label, labelSize) &
      bind(C, name='Polynomial1dLabelSet')
   use iso_c_binding
   implicit none
   type(c_ptr), value :: handle
   integer(c_size_t), intent(in), value :: labelSize
   character(c_char), intent(in) :: label(labelSize)
end subroutine Polynomial1dLabelSet
...
!! Has
function Polynomial1dUncertaintyHas(handle) &
      bind(C, name='Polynomial1dUncertaintyHas')
   use iso_c_binding
   implicit none
   type(c_ptr), intent(in), value :: handle
   integer(c_int) :: Polynomial1dUncertaintyHas
end function Polynomial1dUncertaintyHas

!! Get, const
function Polynomial1dUncertaintyGetConst(handle) &
      bind(C, name='Polynomial1dUncertaintyGetConst')
   use iso_c_binding
   implicit none
   type(c_ptr), intent(in), value :: handle
...
function Polynomial1dUncertaintyGet(handle) &
   ...
   implicit none
   type(c_ptr), value :: handle
   type(c_ptr) :: Polynomial1dUncertaintyGet
end function Polynomial1dUncertaintyGet

!! Set
subroutine Polynomial1dUncertaintySet(handle, fieldHandle) &
      bind(C, name='Polynomial1dUncertaintySet')
   use iso_c_binding
   implicit none
   type(c_ptr), value :: handle
   type(c_ptr), intent(in), value :: fieldHandle
end subroutine Polynomial1dUncertaintySet
...
end module generalPolynomial1d
