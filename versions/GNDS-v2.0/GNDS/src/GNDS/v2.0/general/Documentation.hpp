...
#ifndef GNDS_V2_0_GENERAL_DOCUMENTATION
#define GNDS_V2_0_GENERAL_DOCUMENTATION
...
public:
   ...
   NJOY_GNDSTK_SHORTCUT(authors(),author);
   NJOY_GNDSTK_SHORTCUT(dates(),date);
   ...
   #include "GNDS/v2.0/general/Documentation/src/custom.hpp"
