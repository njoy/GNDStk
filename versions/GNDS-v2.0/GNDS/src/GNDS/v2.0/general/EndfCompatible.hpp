...
#ifndef GNDS_V2_0_GENERAL_ENDFCOMPATIBLE
#define GNDS_V2_0_GENERAL_ENDFCOMPATIBLE
   ...
   public DataNode<std::string,true>
{
   ...
   static auto NODENAME() { return "endfCompatible"; }
...
public:
   ...
   #include "GNDS/v2.0/general/EndfCompatible/src/custom.hpp"
