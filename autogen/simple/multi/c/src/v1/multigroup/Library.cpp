...
{
   return detail::hasField<CPP>
      (CLASSNAME, CLASSNAME+"ElementHas", self, extract::element);
}
...
LibraryElementClear(ConstHandle2Library self)
{
   detail::clearContainer<CPP>
      (CLASSNAME, CLASSNAME+"ElementClear", self, extract::element);
}
...
LibraryElementSize(ConstHandle2ConstLibrary self)
{
   return detail::sizeOfContainer<CPP>
      (CLASSNAME, CLASSNAME+"ElementSize", self, extract::element);
}
...
LibraryElementAdd(ConstHandle2Library self, ConstHandle2ConstElement element)
{
   detail::addToContainer<CPP,CPPElement>
      (CLASSNAME, CLASSNAME+"ElementAdd", self, extract::element, element);
}
...
LibraryElementGetConst(ConstHandle2ConstLibrary self, const size_t index_)
{
   return detail::getByIndex<CPP,Handle2ConstElement>
      (CLASSNAME, CLASSNAME+"ElementGetConst", self, extract::element, index_);
}
...
LibraryElementGet(ConstHandle2Library self, const size_t index_)
{
   return detail::getByIndex<CPP,Handle2Element>
      (CLASSNAME, CLASSNAME+"ElementGet", self, extract::element, index_);
}
...
LibraryElementSet(
   ...
   detail::setByIndex<CPP,CPPElement>
      (CLASSNAME, CLASSNAME+"ElementSet", self, extract::element, index_, element);
}
...
LibraryElementHasBySymbol(
   ...
   return detail::hasByMetadatum<CPP>
      (CLASSNAME, CLASSNAME+"ElementHasBySymbol",
       self, extract::element, meta::symbol, symbol);
}
...
LibraryElementSetBySymbol(
   ...
   detail::setByMetadatum<CPP,CPPElement>
      (CLASSNAME, CLASSNAME+"ElementSetBySymbol",
       self, extract::element, meta::symbol, symbol, element);
}
...
LibraryElementHasByAtomicNumber(
   ...
   return detail::hasByMetadatum<CPP>
      (CLASSNAME, CLASSNAME+"ElementHasByAtomicNumber",
       self, extract::element, meta::atomic_number, atomic_number);
}
...
LibraryElementSetByAtomicNumber(
   ...
   detail::setByMetadatum<CPP,CPPElement>
      (CLASSNAME, CLASSNAME+"ElementSetByAtomicNumber",
       self, extract::element, meta::atomic_number, atomic_number, element);
}
