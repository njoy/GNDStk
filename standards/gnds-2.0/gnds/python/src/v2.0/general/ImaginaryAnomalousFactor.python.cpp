...
// wrapper for general::ImaginaryAnomalousFactor
void wrapImaginaryAnomalousFactor(py::module &module)
{
   using namespace alpha;
   using namespace alpha::v2_0;

   // type aliases
   using cppCLASS = general::ImaginaryAnomalousFactor;

   // create the Python object
   py::class_<cppCLASS> object(
      module, "ImaginaryAnomalousFactor",
