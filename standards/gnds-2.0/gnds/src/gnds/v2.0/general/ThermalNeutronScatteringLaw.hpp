...
#ifndef GNDS_V2_0_GENERAL_THERMALNEUTRONSCATTERINGLAW
#define GNDS_V2_0_GENERAL_THERMALNEUTRONSCATTERINGLAW
...
public:
   ...
   #include "gnds/v2.0/general/ThermalNeutronScatteringLaw/src/custom.hpp"
