...
#ifndef GNDS_V2_0_GENERAL_DECAYMODE
#define GNDS_V2_0_GENERAL_DECAYMODE
...
public:
   ...
   NJOY_GNDSTK_SHORTCUT(decayPath(),decay);
   ...
   #include "gnds/v2.0/general/DecayMode/src/custom.hpp"
