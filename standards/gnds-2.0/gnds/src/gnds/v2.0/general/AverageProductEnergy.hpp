...
#ifndef GNDS_V2_0_GENERAL_AVERAGEPRODUCTENERGY
#define GNDS_V2_0_GENERAL_AVERAGEPRODUCTENERGY
...
public:
   ...
   #include "gnds/v2.0/general/AverageProductEnergy/src/custom.hpp"
