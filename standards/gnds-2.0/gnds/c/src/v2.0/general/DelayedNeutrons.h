...
#ifndef C_INTERFACE_ALPHA_V2_0_GENERAL_DELAYEDNEUTRONS
#define C_INTERFACE_ALPHA_V2_0_GENERAL_DELAYEDNEUTRONS
...
#include "v2.0/general/DelayedNeutrons/src/custom.h"
