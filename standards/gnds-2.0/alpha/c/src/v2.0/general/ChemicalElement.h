...
#ifndef C_INTERFACE_ALPHA_V2_0_GENERAL_CHEMICALELEMENT
#define C_INTERFACE_ALPHA_V2_0_GENERAL_CHEMICALELEMENT
...
#include "v2.0/general/ChemicalElement/src/custom.h"
