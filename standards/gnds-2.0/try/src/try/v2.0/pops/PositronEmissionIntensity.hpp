...
#ifndef TRY_V2_0_POPS_POSITRONEMISSIONINTENSITY
#define TRY_V2_0_POPS_POSITRONEMISSIONINTENSITY
...
public:
   ...
   #include "try/v2.0/pops/PositronEmissionIntensity/src/custom.hpp"
