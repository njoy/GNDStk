...
#ifndef TRY_V2_0_POPS_BINDINGENERGY
#define TRY_V2_0_POPS_BINDINGENERGY
...
public:
   ...
   Field<std::optional<std::vector<unknownNamespace::Double>>> Double{this};
   ...
   explicit BindingEnergy(
      ...
      const wrapper<std::optional<std::vector<unknownNamespace::Double>>> &Double = {}
   ) :
   ...
   #include "try/v2.0/pops/BindingEnergy/src/custom.hpp"
