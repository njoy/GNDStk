...
#ifndef TRY_V2_0_COVARIANCE_AVERAGEPARAMETERCOVARIANCE
#define TRY_V2_0_COVARIANCE_AVERAGEPARAMETERCOVARIANCE
...
public:
   ...
   #include "try/v2.0/covariance/AverageParameterCovariance/src/custom.hpp"
