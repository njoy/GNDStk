...
#ifndef TRY_V2_0_CONTAINERS_CONFIDENCEINTERVALS
#define TRY_V2_0_CONTAINERS_CONFIDENCEINTERVALS
...
public:
   ...
   #include "try/v2.0/containers/ConfidenceIntervals/src/custom.hpp"
