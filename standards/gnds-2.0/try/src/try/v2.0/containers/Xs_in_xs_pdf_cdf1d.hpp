...
#ifndef TRY_V2_0_CONTAINERS_XS_IN_XS_PDF_CDF1D
#define TRY_V2_0_CONTAINERS_XS_IN_XS_PDF_CDF1D
...
public:
   ...
   #include "try/v2.0/containers/Xs_in_xs_pdf_cdf1d/src/custom.hpp"
