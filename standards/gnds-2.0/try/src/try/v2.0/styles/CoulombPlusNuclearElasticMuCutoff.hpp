...
#ifndef TRY_V2_0_STYLES_COULOMBPLUSNUCLEARELASTICMUCUTOFF
#define TRY_V2_0_STYLES_COULOMBPLUSNUCLEARELASTICMUCUTOFF
...
public:
   ...
   #include "try/v2.0/styles/CoulombPlusNuclearElasticMuCutoff/src/custom.hpp"
