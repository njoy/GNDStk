...
#ifndef TRY_V2_0_STYLES_PROJECTILEENERGYDOMAIN
#define TRY_V2_0_STYLES_PROJECTILEENERGYDOMAIN
...
public:
   ...
   #include "try/v2.0/styles/ProjectileEnergyDomain/src/custom.hpp"
