...
#ifndef TRY_V2_0_STYLES_ANGULARDISTRIBUTIONRECONSTRUCTED
#define TRY_V2_0_STYLES_ANGULARDISTRIBUTIONRECONSTRUCTED
...
public:
   ...
   #include "try/v2.0/styles/AngularDistributionReconstructed/src/custom.hpp"
