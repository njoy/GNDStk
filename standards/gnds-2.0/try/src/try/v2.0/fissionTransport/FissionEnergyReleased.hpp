...
#ifndef TRY_V2_0_FISSIONTRANSPORT_FISSIONENERGYRELEASED
#define TRY_V2_0_FISSIONTRANSPORT_FISSIONENERGYRELEASED
...
public:
   ...
   #include "try/v2.0/fissionTransport/FissionEnergyReleased/src/custom.hpp"
