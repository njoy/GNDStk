...
#ifndef TRY_V2_0_FISSIONTRANSPORT_NONNEUTRINOENERGY
#define TRY_V2_0_FISSIONTRANSPORT_NONNEUTRINOENERGY
...
public:
   ...
   #include "try/v2.0/fissionTransport/NonNeutrinoEnergy/src/custom.hpp"
