...
#ifndef TRY_V2_0_DOCUMENTATION_CORRECTIONSCRIPT
#define TRY_V2_0_DOCUMENTATION_CORRECTIONSCRIPT
...
public:
   ...
   #include "try/v2.0/documentation/CorrectionScript/src/custom.hpp"
