...
#ifndef TRY_V2_0_DOCUMENTATION_COVARIANCESCRIPT
#define TRY_V2_0_DOCUMENTATION_COVARIANCESCRIPT
...
public:
   ...
   #include "try/v2.0/documentation/CovarianceScript/src/custom.hpp"
