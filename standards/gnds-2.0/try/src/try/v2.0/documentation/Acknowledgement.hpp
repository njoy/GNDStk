...
#ifndef TRY_V2_0_DOCUMENTATION_ACKNOWLEDGEMENT
#define TRY_V2_0_DOCUMENTATION_ACKNOWLEDGEMENT
...
public:
   ...
   #include "try/v2.0/documentation/Acknowledgement/src/custom.hpp"
