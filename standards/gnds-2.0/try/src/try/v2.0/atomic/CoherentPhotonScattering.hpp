...
#ifndef TRY_V2_0_ATOMIC_COHERENTPHOTONSCATTERING
#define TRY_V2_0_ATOMIC_COHERENTPHOTONSCATTERING
...
public:
   ...
   #include "try/v2.0/atomic/CoherentPhotonScattering/src/custom.hpp"
