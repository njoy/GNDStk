...
#ifndef TRY_V2_0_TSL_THERMALNEUTRONSCATTERINGLAW_COHERENTELASTIC
#define TRY_V2_0_TSL_THERMALNEUTRONSCATTERINGLAW_COHERENTELASTIC
...
public:
   ...
   #include "try/v2.0/tsl/ThermalNeutronScatteringLaw_coherentElastic/src/custom.hpp"
