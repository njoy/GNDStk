...
#ifndef TRY_V2_0_TSL_THERMALNEUTRONSCATTERINGLAW
#define TRY_V2_0_TSL_THERMALNEUTRONSCATTERINGLAW
...
public:
   ...
   #include "try/v2.0/tsl/ThermalNeutronScatteringLaw/src/custom.hpp"
