...
#ifndef TRY_V2_0_TRANSPORT_WEIGHTEDFUNCTIONALS
#define TRY_V2_0_TRANSPORT_WEIGHTEDFUNCTIONALS
...
public:
   ...
   #include "try/v2.0/transport/WeightedFunctionals/src/custom.hpp"
