...
#ifndef TRY_V2_0_RESONANCES_RESONANCEREACTIONS
#define TRY_V2_0_RESONANCES_RESONANCEREACTIONS
...
public:
   ...
   #include "try/v2.0/resonances/ResonanceReactions/src/custom.hpp"
