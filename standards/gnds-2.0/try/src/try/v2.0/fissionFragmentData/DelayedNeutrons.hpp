...
#ifndef TRY_V2_0_FISSIONFRAGMENTDATA_DELAYEDNEUTRONS
#define TRY_V2_0_FISSIONFRAGMENTDATA_DELAYEDNEUTRONS
...
public:
   ...
   #include "try/v2.0/fissionFragmentData/DelayedNeutrons/src/custom.hpp"
