...
// wrapper for styles::EqualProbableBins
void wrapEqualProbableBins(py::module &module)
{
   using namespace test;
   using namespace test::v2_0;

   // type aliases
   using cppCLASS = styles::EqualProbableBins;

   // create the Python object
   py::class_<cppCLASS> object(
      module, "EqualProbableBins",
   ...
   // get/set numberOfBins
   object.def_property(
      "number_of_bins",
      [](const cppCLASS &self) -> decltype(auto)
      {
         return self.numberOfBins();
      },
      [](cppCLASS &self, const Integer32 &value)
      {
         self.numberOfBins() = value;
      },
      cppCLASS::component_t::documentation("number_of_bins").data()
   );
