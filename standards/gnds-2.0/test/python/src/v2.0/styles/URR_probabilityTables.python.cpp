...
// wrapper for styles::URR_probabilityTables
void wrapURR_probabilityTables(py::module &module)
{
   using namespace test;
   using namespace test::v2_0;

   // type aliases
   using cppCLASS = styles::URR_probabilityTables;

   // create the Python object
   py::class_<cppCLASS> object(
      module, "URR_probabilityTables",
