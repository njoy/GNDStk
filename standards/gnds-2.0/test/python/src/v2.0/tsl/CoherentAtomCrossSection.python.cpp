...
// wrapper for tsl::CoherentAtomCrossSection
void wrapCoherentAtomCrossSection(py::module &module)
{
   using namespace test;
   using namespace test::v2_0;

   // type aliases
   using cppCLASS = tsl::CoherentAtomCrossSection;

   // create the Python object
   py::class_<cppCLASS> object(
      module, "CoherentAtomCrossSection",
