...
// wrapper for documentation::CovarianceScript
void wrapCovarianceScript(py::module &module)
{
   using namespace test;
   using namespace test::v2_0;

   // type aliases
   using cppCLASS = documentation::CovarianceScript;

   // create the Python object
   py::class_<cppCLASS> object(
      module, "CovarianceScript",
