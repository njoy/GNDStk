...
// wrapper for documentation::ExecutionArguments
void wrapExecutionArguments(py::module &module)
{
   using namespace test;
   using namespace test::v2_0;

   // type aliases
   using cppCLASS = documentation::ExecutionArguments;

   // create the Python object
   py::class_<cppCLASS> object(
      module, "ExecutionArguments",
