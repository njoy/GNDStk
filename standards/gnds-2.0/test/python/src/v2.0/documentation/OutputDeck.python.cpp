...
// wrapper for documentation::OutputDeck
void wrapOutputDeck(py::module &module)
{
   using namespace test;
   using namespace test::v2_0;

   // type aliases
   using cppCLASS = documentation::OutputDeck;
   ...
   object.def_property(
      ...
      cppCLASS::component_t::documentation("filename").data()
   );
