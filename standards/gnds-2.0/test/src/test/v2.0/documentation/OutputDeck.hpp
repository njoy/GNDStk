   ...
   public Component<documentation::OutputDeck,true>
{
   ...
   static auto NODENAME() { return "outputDeck"; }
...
public:
   ...
   explicit OutputDeck(const std::vector<T> &vector) :
      GNDSTK_COMPONENT(BlockData{})
   {
   ...
   // copy
   OutputDeck &operator=(const OutputDeck &other)
   {
      if (this != &other) {
   ...
   // move
   OutputDeck &operator=(OutputDeck &&other)
   {
      if (this != &other) {
