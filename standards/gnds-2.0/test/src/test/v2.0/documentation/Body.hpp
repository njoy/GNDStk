...
#ifndef TEST_V2_0_DOCUMENTATION_BODY
#define TEST_V2_0_DOCUMENTATION_BODY
...
class Body :
   public Component<documentation::Body,true>
{
...
public:
   ...
   #include "test/v2.0/documentation/Body/src/custom.hpp"
