...
#ifndef TEST_V2_0_DOCUMENTATION_TITLE
#define TEST_V2_0_DOCUMENTATION_TITLE
...
class Title : public Component<documentation::Title,true> {
...
public:
   ...
   #include "test/v2.0/documentation/Title/src/custom.hpp"
