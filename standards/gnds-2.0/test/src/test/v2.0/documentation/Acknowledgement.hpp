...
class Acknowledgement :
   public Component<documentation::Acknowledgement,true>
{
   ...
   static auto NODENAME() { return "acknowledgement"; }
...
public:
   ...
   explicit Acknowledgement(const std::vector<T> &vector) :
      GNDSTK_COMPONENT(BlockData{})
   {
   ...
   // move
   Acknowledgement &operator=(Acknowledgement &&other)
   {
      if (this != &other) {
