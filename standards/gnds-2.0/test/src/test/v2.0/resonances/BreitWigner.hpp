   ...
   static auto KEYS()
   {
      return
         ...
         --Child<std::optional<resonances::HardSphereRadius>>
            ("hardSphereRadius") |
         --Child<std::optional<resonances::ResonanceParameters>>
            ("resonanceParameters")
      ;
   }
...
public:
   ...
   Field<std::optional<resonances::ResonanceParameters>>
   ...
   explicit BreitWigner(
      ...
      const wrapper<std::optional<resonances::HardSphereRadius>>
         &hardSphereRadius = {},
      const wrapper<std::optional<resonances::ResonanceParameters>>
         &resonanceParameters = {}
   ) :
      GNDSTK_COMPONENT(BlockData{}),
      label(this,label),
