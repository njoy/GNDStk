...
#ifndef TEST_V2_0_TRANSPORT_FASTREGION
#define TEST_V2_0_TRANSPORT_FASTREGION
...
class FastRegion :
   public Component<transport::FastRegion>
{
...
public:
   ...
   #include "test/v2.0/transport/FastRegion/src/custom.hpp"
