...
#ifndef TEST_V2_0_TRANSPORT_MULTIPLICITY
#define TEST_V2_0_TRANSPORT_MULTIPLICITY
...
class Multiplicity :
   public Component<transport::Multiplicity>
{
...
public:
   ...
   #include "test/v2.0/transport/Multiplicity/src/custom.hpp"
