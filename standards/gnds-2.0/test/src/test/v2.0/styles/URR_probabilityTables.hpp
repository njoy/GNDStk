   ...
   public Component<styles::URR_probabilityTables>
{
   ...
   static auto NODENAME() { return "URR_probabilityTables"; }
...
public:
   ...
   // copy
   URR_probabilityTables &operator=(const URR_probabilityTables &other)
   {
      if (this != &other) {
   ...
   // move
   URR_probabilityTables &operator=(URR_probabilityTables &&other)
   {
      if (this != &other) {
