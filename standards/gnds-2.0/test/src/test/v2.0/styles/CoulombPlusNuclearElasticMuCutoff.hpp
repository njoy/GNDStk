   ...
   public Component<styles::CoulombPlusNuclearElasticMuCutoff>
{
   ...
   static auto NODENAME() { return "CoulombPlusNuclearElasticMuCutoff"; }
...
public:
   ...
   // copy
   CoulombPlusNuclearElasticMuCutoff &operator=(const CoulombPlusNuclearElasticMuCutoff &other)
   {
      if (this != &other) {
   ...
   // move
   CoulombPlusNuclearElasticMuCutoff &operator=(CoulombPlusNuclearElasticMuCutoff &&other)
   {
      if (this != &other) {
