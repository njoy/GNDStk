...
#ifndef TEST_V2_0_COMMON_PROBABILITY
#define TEST_V2_0_COMMON_PROBABILITY
...
class Probability :
   public Component<common::Probability>
{
...
public:
   ...
   // children
   Field<std::optional<containers::Double>>
      Double{this};
   ...
   explicit Probability(
      const wrapper<std::optional<containers::Double>>
         &Double
   ) :
      GNDSTK_COMPONENT(BlockData{}),
      Double(this,Double)
   ...
   #include "test/v2.0/common/Probability/src/custom.hpp"
