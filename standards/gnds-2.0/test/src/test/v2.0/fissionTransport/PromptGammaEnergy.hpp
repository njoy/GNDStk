...
#define TEST_V2_0_FISSIONTRANSPORT_PROMPTGAMMAENERGY
...
class PromptGammaEnergy :
   public Component<fissionTransport::PromptGammaEnergy>
{
...
public:
   ...
   #include "test/v2.0/fissionTransport/PromptGammaEnergy/src/custom.hpp"
