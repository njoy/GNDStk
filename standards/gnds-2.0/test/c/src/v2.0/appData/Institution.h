...
#ifndef C_INTERFACE_TEST_V2_0_APPDATA_INSTITUTION
#define C_INTERFACE_TEST_V2_0_APPDATA_INSTITUTION
...
// +++ Set
extern_c void
InstitutionLabelSet(ConstHandle2Institution self, const XMLName label);
