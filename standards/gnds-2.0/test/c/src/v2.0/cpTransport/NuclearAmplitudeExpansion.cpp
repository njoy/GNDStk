...
#include "test/v2_0/cpTransport/NuclearAmplitudeExpansion.hpp"
...
using CPPNuclearTerm = cpTransport::NuclearTerm;
using CPPRealInterferenceTerm = cpTransport::RealInterferenceTerm;
using CPPImaginaryInterferenceTerm = cpTransport::ImaginaryInterferenceTerm;
