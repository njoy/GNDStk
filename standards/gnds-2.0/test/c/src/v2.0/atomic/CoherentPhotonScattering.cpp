...
#include "test/v2_0/atomic/CoherentPhotonScattering.hpp"
...
// Set
void
CoherentPhotonScatteringLabelSet(ConstHandle2CoherentPhotonScattering self, const XMLName label)
{
   detail::setField<CPP>
...
// Set
void
CoherentPhotonScatteringPidSet(ConstHandle2CoherentPhotonScattering self, const XMLName pid)
{
   detail::setField<CPP>
...
// Set
void
CoherentPhotonScatteringProductFrameSet(ConstHandle2CoherentPhotonScattering self, const enums::Frame productFrame)
{
   detail::setField<CPP>
