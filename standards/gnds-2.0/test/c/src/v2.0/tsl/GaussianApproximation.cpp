...
#include "test/v2_0/tsl/GaussianApproximation.hpp"
#include "GaussianApproximation.h"

using namespace njoy::GNDStk;
using namespace test::v2_0;

using C = GaussianApproximationClass;
using CPP = multigroup::GaussianApproximation;

static const std::string CLASSNAME = "GaussianApproximation";

namespace extract {
   static auto phononSpectrum = [](auto &obj) { return &obj.phononSpectrum; };
}

using CPPPhononSpectrum = tsl::PhononSpectrum;
...
Handle2ConstGaussianApproximation
...
GaussianApproximationCreateConst(
   ...
   ConstHandle2GaussianApproximation handle = detail::createHandle<CPP,C>(
      CLASSNAME, CLASSNAME+"CreateConst",
      detail::tocpp<CPPPhononSpectrum>(phononSpectrum)
   );
   return handle;
}
