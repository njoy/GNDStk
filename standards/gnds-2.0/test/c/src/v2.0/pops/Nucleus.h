...
#ifndef C_INTERFACE_TEST_V2_0_POPS_NUCLEUS
#define C_INTERFACE_TEST_V2_0_POPS_NUCLEUS
...
// +++ Set
extern_c void
NucleusIdSet(ConstHandle2Nucleus self, const XMLName id);
...
// +++ Set
extern_c void
NucleusIndexSet(ConstHandle2Nucleus self, const Integer32 index);
...
// +++ Has
extern_c int
NucleusFissionFragmentDataHas(ConstHandle2ConstNucleus self);

// --- Get, const
extern_c Handle2ConstFissionFragmentData
NucleusFissionFragmentDataGetConst(ConstHandle2ConstNucleus self);

// +++ Get, non-const
extern_c Handle2FissionFragmentData
NucleusFissionFragmentDataGet(ConstHandle2Nucleus self);

// +++ Set
extern_c void
NucleusFissionFragmentDataSet(ConstHandle2Nucleus self, ConstHandle2ConstFissionFragmentData fissionFragmentData);
