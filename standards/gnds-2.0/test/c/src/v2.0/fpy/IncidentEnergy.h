...
#ifndef C_INTERFACE_TEST_V2_0_FPY_INCIDENTENERGY
#define C_INTERFACE_TEST_V2_0_FPY_INCIDENTENERGY
...
// +++ Set
extern_c void
IncidentEnergyLabelSet(ConstHandle2IncidentEnergy self, const XMLName label);
...
#include "v2.0/fpy/IncidentEnergy/src/custom.h"
