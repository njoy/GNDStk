...
{
   return detail::hasField<CPP>
      (CLASSNAME, CLASSNAME+"EnergyIntervalHas", self, extract::energyInterval);
}
...
EnergyIntervalsEnergyIntervalClear(ConstHandle2EnergyIntervals self)
{
   detail::clearContainer<CPP>
      (CLASSNAME, CLASSNAME+"EnergyIntervalClear", self, extract::energyInterval);
}
...
EnergyIntervalsEnergyIntervalSize(ConstHandle2ConstEnergyIntervals self)
{
   return detail::sizeOfContainer<CPP>
      (CLASSNAME, CLASSNAME+"EnergyIntervalSize", self, extract::energyInterval);
}
...
EnergyIntervalsEnergyIntervalAdd(ConstHandle2EnergyIntervals self, ConstHandle2ConstEnergyInterval energyInterval)
{
   detail::addToContainer<CPP,CPPEnergyInterval>
      (CLASSNAME, CLASSNAME+"EnergyIntervalAdd", self, extract::energyInterval, energyInterval);
}
...
EnergyIntervalsEnergyIntervalGetConst(ConstHandle2ConstEnergyIntervals self, const size_t index_)
{
   return detail::getByIndex<CPP,Handle2ConstEnergyInterval>
      (CLASSNAME, CLASSNAME+"EnergyIntervalGetConst", self, extract::energyInterval, index_);
}
...
EnergyIntervalsEnergyIntervalGet(ConstHandle2EnergyIntervals self, const size_t index_)
{
   return detail::getByIndex<CPP,Handle2EnergyInterval>
      (CLASSNAME, CLASSNAME+"EnergyIntervalGet", self, extract::energyInterval, index_);
}
...
EnergyIntervalsEnergyIntervalSet(
   ...
   detail::setByIndex<CPP,CPPEnergyInterval>
      (CLASSNAME, CLASSNAME+"EnergyIntervalSet", self, extract::energyInterval, index_, energyInterval);
}
...
EnergyIntervalsEnergyIntervalHasByIndex(
   ...
   return detail::hasByMetadatum<CPP>
      (CLASSNAME, CLASSNAME+"EnergyIntervalHasByIndex",
       self, extract::energyInterval, meta::index, index);
}
...
EnergyIntervalsEnergyIntervalSetByIndex(
   ...
   detail::setByMetadatum<CPP,CPPEnergyInterval>
      (CLASSNAME, CLASSNAME+"EnergyIntervalSetByIndex",
       self, extract::energyInterval, meta::index, index, energyInterval);
}
...
EnergyIntervalsEnergyIntervalHasByDomainMin(
   ...
   return detail::hasByMetadatum<CPP>
      (CLASSNAME, CLASSNAME+"EnergyIntervalHasByDomainMin",
       self, extract::energyInterval, meta::domainMin, domainMin);
}
...
EnergyIntervalsEnergyIntervalSetByDomainMin(
   ...
   detail::setByMetadatum<CPP,CPPEnergyInterval>
      (CLASSNAME, CLASSNAME+"EnergyIntervalSetByDomainMin",
       self, extract::energyInterval, meta::domainMin, domainMin, energyInterval);
}
...
EnergyIntervalsEnergyIntervalHasByDomainMax(
   ...
   return detail::hasByMetadatum<CPP>
      (CLASSNAME, CLASSNAME+"EnergyIntervalHasByDomainMax",
       self, extract::energyInterval, meta::domainMax, domainMax);
}
...
EnergyIntervalsEnergyIntervalHasByDomainUnit(
   ...
   return detail::hasByMetadatum<CPP>
      (CLASSNAME, CLASSNAME+"EnergyIntervalHasByDomainUnit",
       self, extract::energyInterval, meta::domainUnit, domainUnit);
}
...
EnergyIntervalsEnergyIntervalSetByDomainUnit(
   ...
   detail::setByMetadatum<CPP,CPPEnergyInterval>
      (CLASSNAME, CLASSNAME+"EnergyIntervalSetByDomainUnit",
       self, extract::energyInterval, meta::domainUnit, domainUnit, energyInterval);
}
