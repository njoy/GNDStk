...
#ifndef C_INTERFACE_TEST_V2_0_CONTAINERS_CONFIDENCEINTERVALS
#define C_INTERFACE_TEST_V2_0_CONTAINERS_CONFIDENCEINTERVALS
...
#include "v2.0/containers/ConfidenceIntervals/src/custom.h"
