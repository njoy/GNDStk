...
#include "test/v2_0/containers/Regions1d.hpp"
#include "Regions1d.h"
...
// Set
void
Regions1dLabelSet(ConstHandle2Regions1d self, const XMLName label)
{
   detail::setField<CPP>
...
// Set
void
Regions1dOuterDomainValueSet(ConstHandle2Regions1d self, const Float64 outerDomainValue)
{
   detail::setField<CPP>
