...
//
// Cdf_in_xs_pdf_cdf1d is the basic handle type in this file. Example:
//    // Create a default Cdf_in_xs_pdf_cdf1d object:
//    Cdf_in_xs_pdf_cdf1d handle = Cdf_in_xs_pdf_cdf1dDefault();
// Functions involving Cdf_in_xs_pdf_cdf1d are declared throughout this file.
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
...
#ifndef C_INTERFACE_TEST_V2_0_CONTAINERS_CDF_IN_XS_PDF_CDF1D
#define C_INTERFACE_TEST_V2_0_CONTAINERS_CDF_IN_XS_PDF_CDF1D
...
typedef struct Cdf_in_xs_pdf_cdf1dClass *Cdf_in_xs_pdf_cdf1d;

// --- Const-aware handles.
typedef const struct Cdf_in_xs_pdf_cdf1dClass *const ConstHandle2ConstCdf_in_xs_pdf_cdf1d;
typedef       struct Cdf_in_xs_pdf_cdf1dClass *const ConstHandle2Cdf_in_xs_pdf_cdf1d;
typedef const struct Cdf_in_xs_pdf_cdf1dClass *      Handle2ConstCdf_in_xs_pdf_cdf1d;
typedef       struct Cdf_in_xs_pdf_cdf1dClass *      Handle2Cdf_in_xs_pdf_cdf1d;
