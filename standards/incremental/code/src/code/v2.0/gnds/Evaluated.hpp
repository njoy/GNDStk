...
#ifndef TEST_V2_0_GNDS_EVALUATED
#define TEST_V2_0_GNDS_EVALUATED
...
public:
   ...
   {
      std::cout << "ctor: Evaluated: 1. default/parameters" << std::endl;
      Component::finish();
   }
   ...
   explicit Evaluated(const Node &node) :
      GNDSTK_COMPONENT(BlockData{})
   {
      std::cout << "ctor: Evaluated: 2. node" << std::endl;
   ...
   {
      std::cout << "ctor: Evaluated: 4. copy" << std::endl;
      *this = other;
   ...
   Evaluated(Evaluated &&other) :
      GNDSTK_COMPONENT(other.baseBlockData())
   {
      std::cout << "ctor: Evaluated: 5. move" << std::endl;
      *this = std::move(other);
      Component::finish(other);
   }
   ...
   #include "test/v2.0/gnds/Evaluated/src/custom.hpp"
