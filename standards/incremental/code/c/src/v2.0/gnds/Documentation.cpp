...
#include "code/v2_0/gnds/Documentation.hpp"
...
using CPPAuthors = gnds::Authors;
using CPPDates = gnds::Dates;
using CPPTitle = gnds::Title;
using CPPBody = gnds::Body;
using CPPEndfCompatible = gnds::EndfCompatible;
...
#include "v2.0/gnds/Documentation/src/custom.cpp"
