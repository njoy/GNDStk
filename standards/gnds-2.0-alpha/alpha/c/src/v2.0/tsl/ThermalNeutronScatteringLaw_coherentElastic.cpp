...
#include "alpha/v2_0/tsl/ThermalNeutronScatteringLaw_coherentElastic.hpp"
...
// Set
void
ThermalNeutronScatteringLaw_coherentElasticLabelSet(ConstHandle2ThermalNeutronScatteringLaw_coherentElastic This, const char *const label)
{
   detail::setField<CPP>
...
// Set
void
ThermalNeutronScatteringLaw_coherentElasticPidSet(ConstHandle2ThermalNeutronScatteringLaw_coherentElastic This, const char *const pid)
{
   detail::setField<CPP>
...
// Set
void
ThermalNeutronScatteringLaw_coherentElasticProductFrameSet(ConstHandle2ThermalNeutronScatteringLaw_coherentElastic This, const char *const productFrame)
{
   detail::setField<CPP>
...
// Has
int
ThermalNeutronScatteringLaw_coherentElasticS_tableHas(ConstHandle2ConstThermalNeutronScatteringLaw_coherentElastic This)
{
   return detail::hasField<CPP>
      (CLASSNAME, CLASSNAME+"S_tableHas", This, extract::S_table);
}

// Get, const
Handle2ConstS_table
ThermalNeutronScatteringLaw_coherentElasticS_tableGetConst(ConstHandle2ConstThermalNeutronScatteringLaw_coherentElastic This)
{
   return detail::getField<CPP,Handle2ConstS_table>
      (CLASSNAME, CLASSNAME+"S_tableGetConst", This, extract::S_table);
}

// Get, non-const
Handle2S_table
ThermalNeutronScatteringLaw_coherentElasticS_tableGet(ConstHandle2ThermalNeutronScatteringLaw_coherentElastic This)
{
   return detail::getField<CPP,Handle2S_table>
      (CLASSNAME, CLASSNAME+"S_tableGet", This, extract::S_table);
}

// Set
void
ThermalNeutronScatteringLaw_coherentElasticS_tableSet(ConstHandle2ThermalNeutronScatteringLaw_coherentElastic This, ConstHandle2ConstS_table S_table)
{
   detail::setField<CPP,CPPS_table>
      (CLASSNAME, CLASSNAME+"S_tableSet", This, extract::S_table, S_table);
}
