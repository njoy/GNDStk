...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_LISTOFCOVARIANCES
#define C_INTERFACE_ALPHA_V2_0_MEAN_LISTOFCOVARIANCES
...
#include "v2.0/mean/ListOfCovariances/src/custom.h"
