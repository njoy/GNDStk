...
#include "alpha/v2_0/mean/Widths.hpp"
#include "Widths.h"
...
WidthsWidthHasByLabel(
   ...
   return detail::hasByMetadatum<CPP>
      (CLASSNAME, CLASSNAME+"WidthHasByLabel",
       This, extract::width, meta::label, label);
}
...
WidthsWidthSetByLabel(
   ...
   detail::setByMetadatum<CPP,CPPWidth>
      (CLASSNAME, CLASSNAME+"WidthSetByLabel",
       This, extract::width, meta::label, label, width);
}
...
#include "v2.0/mean/Widths/src/custom.cpp"
