...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_GENERALEVAPORATION
#define C_INTERFACE_ALPHA_V2_0_MEAN_GENERALEVAPORATION
...
#include "v2.0/mean/GeneralEvaporation/src/custom.h"
