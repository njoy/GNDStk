...
#include "alpha/v2_0/mean/Background.hpp"
...
using CPPResolvedRegion = mean::ResolvedRegion;
using CPPFastRegion = mean::FastRegion;
using CPPUnresolvedRegion = mean::UnresolvedRegion;
...
#include "v2.0/mean/Background/src/custom.cpp"
