...
#include "alpha/v2_0/mean/RMatrix.hpp"
#include "RMatrix.h"
...
using CPPResonanceReactions = mean::ResonanceReactions;
using CPPSpinGroups = mean::SpinGroups;
...
#include "v2.0/mean/RMatrix/src/custom.cpp"
