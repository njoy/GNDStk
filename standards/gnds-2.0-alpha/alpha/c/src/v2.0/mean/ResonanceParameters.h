...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_RESONANCEPARAMETERS
#define C_INTERFACE_ALPHA_V2_0_MEAN_RESONANCEPARAMETERS
...
#include "v2.0/mean/ResonanceParameters/src/custom.h"
