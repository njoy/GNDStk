...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_DELAYEDBETAENERGY
#define C_INTERFACE_ALPHA_V2_0_MEAN_DELAYEDBETAENERGY
...
#include "v2.0/mean/DelayedBetaEnergy/src/custom.h"
