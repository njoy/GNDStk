...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_FISSIONCOMPONENTS
#define C_INTERFACE_ALPHA_V2_0_MEAN_FISSIONCOMPONENTS
...
#include "v2.0/mean/FissionComponents/src/custom.h"
