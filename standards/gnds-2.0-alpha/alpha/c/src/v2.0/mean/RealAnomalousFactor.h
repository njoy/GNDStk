...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_REALANOMALOUSFACTOR
#define C_INTERFACE_ALPHA_V2_0_MEAN_REALANOMALOUSFACTOR
...
#include "v2.0/mean/RealAnomalousFactor/src/custom.h"
