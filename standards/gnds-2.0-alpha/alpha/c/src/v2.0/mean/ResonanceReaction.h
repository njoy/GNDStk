...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_RESONANCEREACTION
#define C_INTERFACE_ALPHA_V2_0_MEAN_RESONANCEREACTION
...
#include "v2.0/mean/ResonanceReaction/src/custom.h"
