...
#include "alpha/v2_0/mean/SpinGroup.hpp"
#include "SpinGroup.h"
...
using CPPChannels = mean::Channels;
using CPPResonanceParameters = mean::ResonanceParameters;
...
#include "v2.0/mean/SpinGroup/src/custom.cpp"
