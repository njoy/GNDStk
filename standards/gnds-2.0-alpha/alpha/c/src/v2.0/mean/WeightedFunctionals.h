...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_WEIGHTEDFUNCTIONALS
#define C_INTERFACE_ALPHA_V2_0_MEAN_WEIGHTEDFUNCTIONALS
...
#include "v2.0/mean/WeightedFunctionals/src/custom.h"
