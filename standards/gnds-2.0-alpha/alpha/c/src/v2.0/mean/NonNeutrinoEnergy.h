...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_NONNEUTRINOENERGY
#define C_INTERFACE_ALPHA_V2_0_MEAN_NONNEUTRINOENERGY
...
#include "v2.0/mean/NonNeutrinoEnergy/src/custom.h"
