...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_DELAYEDGAMMAENERGY
#define C_INTERFACE_ALPHA_V2_0_MEAN_DELAYEDGAMMAENERGY
...
#include "v2.0/mean/DelayedGammaEnergy/src/custom.h"
