...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_FISSIONENERGYRELEASES
#define C_INTERFACE_ALPHA_V2_0_MEAN_FISSIONENERGYRELEASES
...
#include "v2.0/mean/FissionEnergyReleases/src/custom.h"
