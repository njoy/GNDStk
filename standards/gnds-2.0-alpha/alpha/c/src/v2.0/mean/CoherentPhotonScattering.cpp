...
#include "alpha/v2_0/mean/CoherentPhotonScattering.hpp"
...
using CPPFormFactor = mean::FormFactor;
using CPPRealAnomalousFactor = mean::RealAnomalousFactor;
using CPPImaginaryAnomalousFactor = mean::ImaginaryAnomalousFactor;
...
#include "v2.0/mean/CoherentPhotonScattering/src/custom.cpp"
