...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_RESONANCEREACTIONS
#define C_INTERFACE_ALPHA_V2_0_MEAN_RESONANCEREACTIONS
...
#include "v2.0/mean/ResonanceReactions/src/custom.h"
