...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_FISSIONENERGYRELEASE
#define C_INTERFACE_ALPHA_V2_0_MEAN_FISSIONENERGYRELEASE
...
#include "v2.0/mean/FissionEnergyRelease/src/custom.h"
