...
#include "alpha/v2_0/mean/FissionEnergyReleases.hpp"
...
using CPPFissionEnergyRelease = mean::FissionEnergyRelease;
...
#include "v2.0/mean/FissionEnergyReleases/src/custom.cpp"
