...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_PHOTONEMISSIONPROBABILITIES
#define C_INTERFACE_ALPHA_V2_0_MEAN_PHOTONEMISSIONPROBABILITIES
...
#include "v2.0/mean/PhotonEmissionProbabilities/src/custom.h"
