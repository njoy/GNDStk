...
#ifndef C_INTERFACE_ALPHA_V2_0_MEAN_IMAGINARYANOMALOUSFACTOR
#define C_INTERFACE_ALPHA_V2_0_MEAN_IMAGINARYANOMALOUSFACTOR
...
#include "v2.0/mean/ImaginaryAnomalousFactor/src/custom.h"
