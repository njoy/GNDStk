...
#include "alpha/v2_0/mean/IncoherentPhotonScattering.hpp"
...
using CPPScatteringFactor = mean::ScatteringFactor;
...
#include "v2.0/mean/IncoherentPhotonScattering/src/custom.cpp"
