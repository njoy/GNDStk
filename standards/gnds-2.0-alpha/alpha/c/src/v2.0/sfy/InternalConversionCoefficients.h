...
#ifndef C_INTERFACE_ALPHA_V2_0_SFY_INTERNALCONVERSIONCOEFFICIENTS
#define C_INTERFACE_ALPHA_V2_0_SFY_INTERNALCONVERSIONCOEFFICIENTS
...
#include "v2.0/sfy/InternalConversionCoefficients/src/custom.h"
