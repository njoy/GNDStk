...
#ifndef C_INTERFACE_ALPHA_V2_0_SFY_POSITRONEMISSIONINTENSITY
#define C_INTERFACE_ALPHA_V2_0_SFY_POSITRONEMISSIONINTENSITY
...
#include "v2.0/sfy/PositronEmissionIntensity/src/custom.h"
