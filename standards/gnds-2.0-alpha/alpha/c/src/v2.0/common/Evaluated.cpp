...
#include "alpha/v2_0/common/Evaluated.hpp"
#include "Evaluated.h"
...
using CPPDocumentation = common::Documentation;
using CPPTemperature = common::Temperature;
using CPPProjectileEnergyDomain = common::ProjectileEnergyDomain;
...
#include "v2.0/common/Evaluated/src/custom.cpp"
