...
#include "alpha/v2_0/common/Energy.hpp"
#include "Energy.h"
...
using CPPNBodyPhaseSpace = mean::NBodyPhaseSpace;
using CPPPrimaryGamma = mean::PrimaryGamma;
using CPPDiscreteGamma = mean::DiscreteGamma;
using CPPXYs2d = mean::XYs2d;
using CPPGeneralEvaporation = mean::GeneralEvaporation;
using CPPEvaporation = mean::Evaporation;
using CPPWeightedFunctionals = mean::WeightedFunctionals;
using CPPSimpleMaxwellianFission = mean::SimpleMaxwellianFission;
using CPPMadlandNix = gfiles::MadlandNix;
