...
#include "alpha/v2_0/common/Reaction.hpp"
#include "Reaction.h"
...
using CPPDoubleDifferentialCrossSection = common::DoubleDifferentialCrossSection;
...
#include "v2.0/common/Reaction/src/custom.cpp"
