...
#ifndef C_INTERFACE_ALPHA_V2_0_COMMON_PROJECTILEENERGYDOMAIN
#define C_INTERFACE_ALPHA_V2_0_COMMON_PROJECTILEENERGYDOMAIN
...
#include "v2.0/common/ProjectileEnergyDomain/src/custom.h"
