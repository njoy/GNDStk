...
#include "alpha/v2_0/common/DecayData.hpp"
#include "DecayData.h"
...
using CPPDecayModes = common::DecayModes;
using CPPAverageEnergies = sfy::AverageEnergies;
...
#include "v2.0/common/DecayData/src/custom.cpp"
