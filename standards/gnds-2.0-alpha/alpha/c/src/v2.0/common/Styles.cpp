...
#include "alpha/v2_0/common/Styles.hpp"
#include "Styles.h"
...
using CPPEvaluated = common::Evaluated;
using CPPCrossSectionReconstructed = mean::CrossSectionReconstructed;
...
#include "v2.0/common/Styles/src/custom.cpp"
