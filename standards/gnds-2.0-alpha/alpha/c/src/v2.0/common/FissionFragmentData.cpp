...
#include "alpha/v2_0/common/FissionFragmentData.hpp"
...
using CPPProductYields = common::ProductYields;
using CPPDelayedNeutrons = mean::DelayedNeutrons;
using CPPFissionEnergyReleases = mean::FissionEnergyReleases;
...
#include "v2.0/common/FissionFragmentData/src/custom.cpp"
