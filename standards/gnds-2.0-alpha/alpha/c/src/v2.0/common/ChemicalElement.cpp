...
#include "alpha/v2_0/common/ChemicalElement.hpp"
...
using CPPAtomic = atom::Atomic;
using CPPIsotopes = common::Isotopes;
...
#include "v2.0/common/ChemicalElement/src/custom.cpp"
