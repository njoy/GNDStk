...
#ifndef C_INTERFACE_ALPHA_V2_0_GENERAL_PHOTONEMISSIONPROBABILITIES
#define C_INTERFACE_ALPHA_V2_0_GENERAL_PHOTONEMISSIONPROBABILITIES
...
#include "v2.0/general/PhotonEmissionProbabilities/src/custom.h"
