...
#include "alpha/v2_0/general/PromptProductKE.hpp"
#include "PromptProductKE.h"

using namespace njoy::GNDStk;
using namespace alpha::v2_0;

using C = PromptProductKEClass;
using CPP = multigroup::PromptProductKE;

static const std::string CLASSNAME = "PromptProductKE";
...
PromptProductKECreateConst(
   ...
   ConstHandle2PromptProductKE handle = detail::createHandle<CPP,C>(
...
#include "v2.0/general/PromptProductKE/src/custom.cpp"
