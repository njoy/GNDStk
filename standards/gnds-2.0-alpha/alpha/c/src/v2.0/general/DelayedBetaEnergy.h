...
#ifndef C_INTERFACE_ALPHA_V2_0_GENERAL_DELAYEDBETAENERGY
#define C_INTERFACE_ALPHA_V2_0_GENERAL_DELAYEDBETAENERGY
...
#include "v2.0/general/DelayedBetaEnergy/src/custom.h"
