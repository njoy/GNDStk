...
#ifndef C_INTERFACE_ALPHA_V2_0_GENERAL_RUTHERFORDSCATTERING
#define C_INTERFACE_ALPHA_V2_0_GENERAL_RUTHERFORDSCATTERING
...
#include "v2.0/general/RutherfordScattering/src/custom.h"
