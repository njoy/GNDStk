...
// Set
void
UnspecifiedLabelSet(ConstHandle2Unspecified self, const char *const label)
{
   detail::setField<CPP>
...
// Set
void
UnspecifiedProductFrameSet(ConstHandle2Unspecified self, const char *const productFrame)
{
   detail::setField<CPP>
