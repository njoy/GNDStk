...
#ifndef C_INTERFACE_ALPHA_V2_0_GENERAL_INCIDENTENERGIES
#define C_INTERFACE_ALPHA_V2_0_GENERAL_INCIDENTENERGIES
...
#include "v2.0/general/IncidentEnergies/src/custom.h"
