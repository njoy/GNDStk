...
#ifndef C_INTERFACE_ALPHA_V2_0_GENERAL_IMAGINARYANOMALOUSFACTOR
#define C_INTERFACE_ALPHA_V2_0_GENERAL_IMAGINARYANOMALOUSFACTOR
...
#include "v2.0/general/ImaginaryAnomalousFactor/src/custom.h"
