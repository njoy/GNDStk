...
#ifndef C_INTERFACE_ALPHA_V2_0_GENERAL_SELFSCATTERINGKERNEL
#define C_INTERFACE_ALPHA_V2_0_GENERAL_SELFSCATTERINGKERNEL
...
#include "v2.0/general/SelfScatteringKernel/src/custom.h"
