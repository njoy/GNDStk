...
#ifndef C_INTERFACE_ALPHA_V2_0_GENERAL_SIMPLEMAXWELLIANFISSION
#define C_INTERFACE_ALPHA_V2_0_GENERAL_SIMPLEMAXWELLIANFISSION
...
#include "v2.0/general/SimpleMaxwellianFission/src/custom.h"
