...
#include "alpha/v2_0/general/NeutrinoEnergy.hpp"
#include "NeutrinoEnergy.h"

using namespace njoy::GNDStk;
using namespace alpha::v2_0;

using C = NeutrinoEnergyClass;
using CPP = multigroup::NeutrinoEnergy;

static const std::string CLASSNAME = "NeutrinoEnergy";
...
NeutrinoEnergyCreateConst(
   ...
   ConstHandle2NeutrinoEnergy handle = detail::createHandle<CPP,C>(
...
#include "v2.0/general/NeutrinoEnergy/src/custom.cpp"
