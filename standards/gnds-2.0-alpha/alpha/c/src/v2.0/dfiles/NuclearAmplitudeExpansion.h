...
#ifndef C_INTERFACE_ALPHA_V2_0_DFILES_NUCLEARAMPLITUDEEXPANSION
#define C_INTERFACE_ALPHA_V2_0_DFILES_NUCLEARAMPLITUDEEXPANSION
...
#include "v2.0/dfiles/NuclearAmplitudeExpansion/src/custom.h"
