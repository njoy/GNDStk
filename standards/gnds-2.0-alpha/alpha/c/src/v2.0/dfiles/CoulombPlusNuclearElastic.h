...
#ifndef C_INTERFACE_ALPHA_V2_0_DFILES_COULOMBPLUSNUCLEARELASTIC
#define C_INTERFACE_ALPHA_V2_0_DFILES_COULOMBPLUSNUCLEARELASTIC
...
#include "v2.0/dfiles/CoulombPlusNuclearElastic/src/custom.h"
