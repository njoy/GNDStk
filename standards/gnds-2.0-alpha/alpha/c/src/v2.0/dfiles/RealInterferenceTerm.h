...
#ifndef C_INTERFACE_ALPHA_V2_0_DFILES_REALINTERFERENCETERM
#define C_INTERFACE_ALPHA_V2_0_DFILES_REALINTERFERENCETERM
...
#include "v2.0/dfiles/RealInterferenceTerm/src/custom.h"
