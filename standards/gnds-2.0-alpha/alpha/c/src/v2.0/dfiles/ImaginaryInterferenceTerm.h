...
#ifndef C_INTERFACE_ALPHA_V2_0_DFILES_IMAGINARYINTERFERENCETERM
#define C_INTERFACE_ALPHA_V2_0_DFILES_IMAGINARYINTERFERENCETERM
...
#include "v2.0/dfiles/ImaginaryInterferenceTerm/src/custom.h"
