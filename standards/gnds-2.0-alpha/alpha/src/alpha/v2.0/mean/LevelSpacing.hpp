...
#ifndef ALPHA_V2_0_MEAN_LEVELSPACING
#define ALPHA_V2_0_MEAN_LEVELSPACING
...
class LevelSpacing :
   public Component<mean::LevelSpacing>
{
...
public:
   ...
   #include "alpha/v2.0/mean/LevelSpacing/src/custom.hpp"
