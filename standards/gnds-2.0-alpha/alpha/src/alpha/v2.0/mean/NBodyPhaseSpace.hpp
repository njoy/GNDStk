...
#ifndef ALPHA_V2_0_MEAN_NBODYPHASESPACE
#define ALPHA_V2_0_MEAN_NBODYPHASESPACE
...
class NBodyPhaseSpace :
   public Component<mean::NBodyPhaseSpace>
{
...
public:
   ...
   #include "alpha/v2.0/mean/NBodyPhaseSpace/src/custom.hpp"
