...
#ifndef ALPHA_V2_0_MEAN_RESOLVEDREGION
#define ALPHA_V2_0_MEAN_RESOLVEDREGION
...
class ResolvedRegion :
   public Component<mean::ResolvedRegion>
{
...
public:
   ...
   #include "alpha/v2.0/mean/ResolvedRegion/src/custom.hpp"
