...
#ifndef ALPHA_V2_0_MEAN_PRIMARYGAMMA
#define ALPHA_V2_0_MEAN_PRIMARYGAMMA
...
class PrimaryGamma :
   public Component<mean::PrimaryGamma>
{
...
public:
   ...
   #include "alpha/v2.0/mean/PrimaryGamma/src/custom.hpp"
