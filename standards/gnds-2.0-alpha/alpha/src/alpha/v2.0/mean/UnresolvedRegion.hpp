...
#ifndef ALPHA_V2_0_MEAN_UNRESOLVEDREGION
#define ALPHA_V2_0_MEAN_UNRESOLVEDREGION
...
class UnresolvedRegion :
   public Component<mean::UnresolvedRegion>
{
...
public:
   ...
   #include "alpha/v2.0/mean/UnresolvedRegion/src/custom.hpp"
