...
#ifndef ALPHA_V2_0_MEAN_RESONANCEREACTIONS
#define ALPHA_V2_0_MEAN_RESONANCEREACTIONS
...
class ResonanceReactions :
   public Component<mean::ResonanceReactions>
{
...
public:
   ...
   #include "alpha/v2.0/mean/ResonanceReactions/src/custom.hpp"
