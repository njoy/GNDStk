...
#ifndef ALPHA_V2_0_COMMON_ENDFCONVERSIONFLAGS
#define ALPHA_V2_0_COMMON_ENDFCONVERSIONFLAGS
...
class ENDFconversionFlags :
   public Component<common::ENDFconversionFlags>
{
...
public:
   ...
   #include "alpha/v2.0/common/ENDFconversionFlags/src/custom.hpp"
