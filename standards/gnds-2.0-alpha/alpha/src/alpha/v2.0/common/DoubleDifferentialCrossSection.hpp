...
#ifndef ALPHA_V2_0_COMMON_DOUBLEDIFFERENTIALCROSSSECTION
#define ALPHA_V2_0_COMMON_DOUBLEDIFFERENTIALCROSSSECTION
...
class DoubleDifferentialCrossSection :
   public Component<common::DoubleDifferentialCrossSection>
{
...
public:
   ...
   #include "alpha/v2.0/common/DoubleDifferentialCrossSection/src/custom.hpp"
