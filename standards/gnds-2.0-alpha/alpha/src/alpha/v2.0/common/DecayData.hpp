...
#ifndef ALPHA_V2_0_COMMON_DECAYDATA
#define ALPHA_V2_0_COMMON_DECAYDATA
...
class DecayData :
   public Component<common::DecayData>
{
...
public:
   ...
   #include "alpha/v2.0/common/DecayData/src/custom.hpp"
