...
#ifndef ALPHA_V2_0_COVARIANCE_COVARIANCESECTIONS
#define ALPHA_V2_0_COVARIANCE_COVARIANCESECTIONS
...
public:
   ...
   #include "alpha/v2.0/covariance/CovarianceSections/src/custom.hpp"
