...
#ifndef ALPHA_V2_0_COVARIANCE_PARAMETERCOVARIANCES
#define ALPHA_V2_0_COVARIANCE_PARAMETERCOVARIANCES
...
public:
   ...
   #include "alpha/v2.0/covariance/ParameterCovariances/src/custom.hpp"
