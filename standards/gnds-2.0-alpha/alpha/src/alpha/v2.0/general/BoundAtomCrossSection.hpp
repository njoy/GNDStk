...
#ifndef ALPHA_V2_0_GENERAL_BOUNDATOMCROSSSECTION
#define ALPHA_V2_0_GENERAL_BOUNDATOMCROSSSECTION
...
public:
   ...
   #include "alpha/v2.0/general/BoundAtomCrossSection/src/custom.hpp"
