...
#ifndef ALPHA_V2_0_TSL_THERMALNEUTRONSCATTERINGLAW
#define ALPHA_V2_0_TSL_THERMALNEUTRONSCATTERINGLAW
...
public:
   ...
   #include "alpha/v2.0/tsl/ThermalNeutronScatteringLaw/src/custom.hpp"
