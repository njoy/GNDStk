...
latex_documents = [
  ('index', 'GNDStk.tex', u'GNDStk Documentation',
   u'Martin Staley', 'manual'),
]
...
man_pages = [
    ('index', 'gndstk', u'GNDStk Documentation',
     [u'Martin Staley'], 1)
]
...
texinfo_documents = [
  ('index', 'GNDStk', u'GNDStk Documentation',
   u'Martin Staley', 'GNDStk', 'One line description of project.',
   'Miscellaneous'),
]
